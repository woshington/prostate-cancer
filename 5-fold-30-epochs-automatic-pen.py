...
def train_model(fold, model, epochs, optimizer, scheduler, train_dataloader, valid_dataloader, valid_dataframe,
    ...
    for epoch in range(1, epochs + 1):
        ...
        with open('logs/history/fold_03_automatic_pen_black.txt', 'a') as f:
            f.write(log_epoch + '\n')
...
valid_indexex = np.where((dataframe_train['fold'] == 3))[0]
...
save_path = f'pre-trained-models/fold_03_30_epochs_automatic_pen_black.pth'
